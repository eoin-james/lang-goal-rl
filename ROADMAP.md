...
|---|-------|-------|-----------|------------|--------|
| 0 | Plumbing | panda-gym or gymnasium-robotics Fetch, vanilla SAC/PPO | training/eval loop, logging | Solves a single fixed-goal task end-to-end | Not started |
| 1 | Goal-conditioned baseline (UVFA + HER) | SB3 `HerReplayBuffer`, same envs | multi-goal conditioning on literal xyz goal | Reproduce published success rate on Reach/Push/PickAndPlace within a few seeds | Not started |
